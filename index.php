        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5"><strong>💘【★𝘽𝙂★】💘</strong></h6>
                ...
                <div class="widget-holder widget-full-height widget-flex col-lg-6">
                   <div class="widget-bg">
                        <div class="widget-heading">
                            <h5 class="widget-title">★ STRIPE 3 REQ★</h5>
                        ...
                        <div class="widget-body">
                            <div class="container-fluid pd-20">
                                <div class="row">
                                    ...
                                    <p> API BY <a target="_BLANK" href="https://telegram.me/Divine_S_99/">
                                    【★𝘽𝙂★】</a></p>
